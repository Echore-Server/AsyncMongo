...
use Echore\AsyncMongo\result\MongoDeleteResult;
 ...
 */
class MongoDeleteOneOperation extends MongoExecutableOperation {
	use FilterOperationTrait;

	public function createExecutable(): DeleteOne {
