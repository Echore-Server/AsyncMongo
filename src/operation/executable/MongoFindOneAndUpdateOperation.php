...
use Echore\AsyncMongo\result\MongoDocumentResult;
 ...
 * @method self returnDocument(string $beforeOrAfter)
 * @method self returnNewDocument(bool $v)
 */
class MongoFindOneAndUpdateOperation extends MongoExecutableOperation {
	...
	public function createExecutable(): FindOneAndUpdate {
		return new FindOneAndUpdate($this->databaseName, $this->collectionName, $this->filter, $this->update, $this->options);
	}
